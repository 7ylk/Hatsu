...
local BaseURL = "https://raw.githubusercontent.com/7ylk/Hatsu/refs/heads/main/Obsidian-main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
    TransparencyTexture = {
        RobloxId = 139785960036434,
        Path = "Hatsu/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "Hatsu/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "Hatsu/assets/LoadingIcon.png",
    ...
    CheckIcon = {
        ...
        Path = "Hatsu/assets/CheckIcon.png",
...
do
    ...
    function CustomImageManager.AddAsset(
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("Hatsu/custom_assets/%s", AssetName),
            URL = URL,
...
function Library:GetCustomIcon(IconName: string): any
    ...
    if CustomImageManagerAssets[IconName] then
        return {
            Url = CustomImageManager.GetAsset(IconName),
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
    warn("Hatsu:MakeOutline is deprecated, please use Hatsu:AddOutline instead.")
