...
local SaveManager = {} do
    SaveManager.Folder = "HatsuLibSettings"
    ...
    function SaveManager:BuildConfigSection(tab, icon)
        ...
        section:AddToggle("SaveManager_AutoExecuteOnTeleport", {
        ...
        -- Automatically write the loader file if HatsuLoader is defined
        if getgenv().HatsuLoader and writefile then
        ...
        self:SetIgnoreIndexes({ "SaveManager_ConfigList", "SaveManager_ConfigName", "SaveManager_AutoExecuteOnTeleport" })
    end
